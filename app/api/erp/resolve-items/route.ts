...
// Manual aliases keyed by the normalized nomenclature key → canonical UAT name.
const ALIAS_BY_KEY = new Map<string, string>(Object.entries(ITEM_ALIASES).map(([k, v]) => [normalizeItem(k), v]))
